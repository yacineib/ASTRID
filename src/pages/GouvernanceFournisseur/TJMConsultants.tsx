...
const TJMConsultants: React.FC = () => {
  return (
    <div className="text-sm p-2">
      <h2 className="p-2 pt-8 text-base text-left font-bold">
        Consultation des comptes prestataires, et le TJM associé :
      </h2>
          ...
          <div className="flex-row ">
            ...
            <div className="col-span-1 mt-4">
              ...
              <select className="mt-1 block w-full p-2 border border-gray-700 rounded-lg">
                ...
                <option value="ActeurMEP">Capgemini</option>
                <option value="Consultant">Atos</option>
              </select>
            </div>
